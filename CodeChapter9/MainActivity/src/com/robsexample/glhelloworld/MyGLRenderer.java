	 ...
	 */
	 ...
	 void CreateCube(Context iContext)
	 {
		 ...
		 */
		 ...
		 m_Cube = new ArenaObject3d(iContext, 
		 		   null,
		 		   CubeMesh, 
				   CubeTex, 
				   Material1, 
	    ...
	    SphericalPolygonExplosion Explosion = CreateExplosion(iContext,
		 ...
		 //SFX
		 m_Cube.CreateHitGroundSFX(m_SoundPool, HitGroundSFX);
	     m_Cube.CreateExplosionSFX(m_SoundPool, ExplosionSFX);
	     m_Cube.SetSFXOnOff(true);
		 ...
		 m_Cube.GetObjectPhysics().ApplyTranslationalForce(Force);
	
		 m_Cube.m_Orientation.SetRotationAxis(AxisRotation);
		 //m_Cube.GetObjectPhysics().ApplyRotationalForce(30, 1);
		 
		 m_Cube.GetObjectPhysics().GetMaxVelocity().Set(MaxVelocity, 1, MaxVelocity);
	 ...
	 */
	 ...
	 {	
    	...
    	public void onSurfaceCreated(GL10 unused, EGLConfig config) 
    	{
    		...
    		// Create a 3d Cube Arena Object based on Grid Size
